# -*- coding: utf-8 -*-
"""
Created on Thu Aug 13 16:33:41 2020
...
cursor = conn.cursor()
cursor.execute("select name, place, category, star, address,category1, address1, address2, count, latitude, longitude, year, month, season from recommend  ")
